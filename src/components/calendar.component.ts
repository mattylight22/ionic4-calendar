  ...
  template: `
    <div class="title">
      ...
      <ng-template [ngIf]="_showToggleButtons">
        <ion-button type="button" fill="clear" class="back calendar-button-left"  [disabled]="!canBack()" (click)="prev()">
          <ion-icon slot="icon-only" size="small" [name]="leftArrowIcon" [style.color]="navArrowColor"></ion-icon>
        </ion-button>
        <ion-button type="button" fill="clear" class="forward calendar-button-right" [disabled]="!canNext()" (click)="next()">
          <ion-icon slot="icon-only" size="small" [name]="rightArrowIcon" [style.color]="navArrowColor"></ion-icon>
        </ion-button>
      </ng-template>
    </div>
...
export class CalendarComponent implements ControlValueAccessor, OnInit {
  ...
  @Input()
  leftArrowIcon: string = "arrow-back-circle-outline";
  @Input()
  rightArrowIcon: string = "arrow-forward-circle-outline";
  @Input()
  navArrowColor: string = "#222";
  @Input()
